import { snacktype } from "./enumerators.js";
...
export default class Snack {
  constructor(instructions) {
    ...
    this.type = !instructions.type || instructions.type == snacktype.default ? "" : instructions.type;
  ...
  static apply(message, type = snacktype.standard, ...spices) {
